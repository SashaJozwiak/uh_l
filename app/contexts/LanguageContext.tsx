...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      'roadmap.y2025.desc': 'Launch of other projects and share trading features. Average user APR exceeds 40%.',
...
'whitepaper.mechanism.text7':
  'When registering an organization, the mechanism must be enshrined in the charter along with the utility mechanism of the token in software products.',
    ...
    ru: {
      ...
      'roadmap.y2025.desc': 'Запуск других проектов и функций торговли их долями. Средний APR пользователей выше 40%.',
